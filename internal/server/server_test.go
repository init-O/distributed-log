...
import (
	...
	api "github.con/init-O/proglog/api/v1"
	"github.con/init-O/proglog/internal/config"
	"github.con/init-O/proglog/internal/log"
...
func testConsumePastLogBoundary(t *testing.T, client api.LogClient, cfg *Config) {
	ctx := context.Background()
